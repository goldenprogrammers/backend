...
public class SubscriptionServiceTest {
    ...
    public void createSubscription() {
        ...
        when(restTemplate.exchange(eq("https://actions-forcaesperanca.up.railway.app/action/isactive/1"), eq(HttpMethod.GET), eq(requestEntity), eq(Map.class))).thenReturn(responseEntity);
